...
namespace Core
{
	QSettings::Format JsonSettings::format = QSettings::registerFormat("json", jsonRead, jsonWrite);

	JsonSettings::JsonSettings(const QString &fileName, QObject *parent):
		QSettings(fileName, JsonSettings::format, parent)
	{
